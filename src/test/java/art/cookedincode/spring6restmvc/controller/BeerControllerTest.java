...
class BeerControllerTest {
    ...
    void testUpdateBeerNullBeerName() throws Exception {
        ...
        given(beerService.updateBeerById(any(), any(BeerDTO.class)))
                .willReturn(Optional.of(beerServiceImpl.listBeers(null, null, false, 1, 25).getContent().getFirst()));
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class)))
                .willReturn(beerServiceImpl.listBeers(null, null, false, 1, 25).getContent().getFirst());
